...
<div class="panel admin-panel">
		<div class="panel-head" id="add">
			<strong><span class="icon-pencil-square-o"></span>添加老师考勤</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x"  
				action="${pageContext.request.contextPath}/kaoqing//success/addTkaoqing">
				<c:forEach var="kq" items="${kq}" varStatus="vs">
					 <span>序号:</span>
					<input name="tid" class="form-control" type="text"
						 value="${kq.tid}" readonly="readonly">
					<br> 
